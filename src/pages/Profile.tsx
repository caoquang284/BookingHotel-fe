             ...
             <form onSubmit={handlePasswordSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="relative">
                 ...
                 <div className="flex items-center">
                   <span className="absolute left-3 text-gray-400">
                     <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 11c1.10457-0 2-0.89543 2-2 0-1.10457-0.89543-2-2-2-1.10457 0-2 0.89543-2 2 0 1.10457 0.89543 2 2 2zM12 17c-2.76142 0-5 2.23858-5 5h10c0-2.76142-2.23858-5-5-5z"></path>
                     </svg>
                   </span>
                   <input
                     type="password"
